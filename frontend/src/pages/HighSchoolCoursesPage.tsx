...
import { Search, Filter, Code2, Clock, Users, Star, Brain, BookOpen, ArrowRight, Globe, Database, Smartphone, Award } from 'lucide-react'
...
export default function HighSchoolCoursesPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Header */}
      <section className="bg-gradient-to-br from-purple-500 via-indigo-500 to-purple-600 text-white py-16">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-xl text-purple-100">
                  Advanced courses preparing you for college and careers (Grades 9-12)
                </p>
              </div>
            </div>
        ...
        <div className="section-container">
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search high school courses..."
                value={searchQuery}
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.map((course) => (
              <Link
                key={course.id}
                to={`/courses/high-school/${course.id}`}
              ...
              >
                <div className="h-48 bg-gradient-to-br from-purple-400 to-indigo-500 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    ...
                    <button 
                      onClick={(e) => {
                        e.preventDefault()
                        navigate(`/courses/high-school/${course.id}`)
                      }}
                      className="btn-primary text-sm px-4 py-2 bg-purple-600 hover:bg-purple-700"
                    >
                      View Details
                    </button>
                  </div>
