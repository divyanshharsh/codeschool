...
import { Search, Filter, Code2, Clock, Users, Star, Sparkles, BookOpen, ArrowRight } from 'lucide-react'
import { getCoursesBySegment } from '../data/courses'

const categoryIcons: Record<string, JSX.Element> = {
  'Block Programming': <Code2 className="h-5 w-5" />,
  'Creative Coding': <Sparkles className="h-5 w-5" />,
}

export default function ElementaryCoursesPage() {
  const navigate = useNavigate()
  const courses = getCoursesBySegment('elementary')
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Header */}
      <section className="bg-gradient-to-br from-pink-500 via-rose-500 to-pink-600 text-white py-16">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-xl text-pink-100">
                  Perfect for young learners (Grades K-5) starting their coding journey
                </p>
              </div>
            </div>
        ...
        <div className="section-container">
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search elementary courses..."
                value={searchQuery}
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.map((course) => (
              <Link
                key={course.id}
                to={`/courses/elementary/${course.id}`}
              ...
              >
                <div className="h-48 bg-gradient-to-br from-pink-400 to-rose-500 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    ...
                    <button 
                      onClick={(e) => {
                        e.preventDefault()
                        navigate(`/courses/elementary/${course.id}`)
                      }}
                      className="btn-primary text-sm px-4 py-2 bg-pink-600 hover:bg-pink-700"
                    >
                      View Details
                    </button>
                  </div>
